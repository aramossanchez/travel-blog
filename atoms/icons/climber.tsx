interface ClimberIconProps {
  color?: string;
  size?: number;
}

export default function ClimberIcon({ color, size = 30 }: ClimberIconProps) {
  return (
    <svg
